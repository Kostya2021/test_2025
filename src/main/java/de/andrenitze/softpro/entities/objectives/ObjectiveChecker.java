...
public class ObjectiveChecker {
    ...
    private boolean checkObjective(Objective objective, Player player, List<Project> projects,
        ...
        switch (objectiveId) {
            case OBJECTIVE_11:
                return checkObjective11(player, projects, objective);
            case OBJECTIVE_12:
                return checkObjective12(player, projectEmployeesMap, objective);
            case OBJECTIVE_13:
                return checkObjective13(player, projectEmployeesMap, objective);
            case OBJECTIVE_14:
            case OBJECTIVE_15:
                return checkObjective14And15(player, objective);
            case OBJECTIVE_16:
                return checkObjective16(player, skillsManager, objective);
            case OBJECTIVE_17:
                return checkObjective17(player, projects, objective);
            case OBJECTIVE_210:
                return checkObjective210(player, skillsManager, objective);
            case OBJECTIVE_220:
                return checkObjective220(player, skillsManager, objective);
            case OBJECTIVE_222:
                return checkObjective222(player, objective);
            case OBJECTIVE_223:
                return checkObjective223(player, objective);
            case OBJECTIVE_230:
                return checkObjective230(player, objective);
            case OBJECTIVE_231:
                return checkObjective231(player, skillsManager, objective);
            case OBJECTIVE_31:
                return checkObjective31(player, projects, objective);
            default:
                return false;
        }
    }

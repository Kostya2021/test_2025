...
public enum ProjectType {
    ...
    public static final List<String> CONSULTING_DOMAINS = List.of("ProcessAssessment,TechnologyEvaluation,FeasibilityStudy,SWOTAnalysis".split(","));
    public static final List<String> DEVELOPMENT_DOMAINS = List.of("JAVA,COBOL,C,dotNET,Python,Swift,Kotlin,JavaScript,Go,PHP,Scala,CSharp".split(","));
    public static final List<String> INTRODUCTION_DOMAINS = List.of("ProcessAssessment,TechnologyEvaluation,FeasibilityStudy,SWOTAnalysis".split(","));
